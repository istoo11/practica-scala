...
![Imagen descarga Jupyter](../images/parte1/instalacion_notebook.png)
...
![Imagen rutas](../images/parte1/abrir_jupiter.png)
...
java --version
```
![Version java](../images/parte1/version_java.png)
...
![Version java](../images/parte1/instalacion_cli.png)
...
![JupyterLab abierto](../images/parte1/notebook_abierto.png)
...
![Codigo prueba](../images/parte1/prueba_codigo.png)
...
![Java](../images/parte1/version_java.png)

   ```bash
   javac -version
   ```

![Javac](../images/parte1/java_javac.png)
...
![SBT instalacion](../images/parte1/instalacion_sbt.png)  
...
![SBT version](../images/parte1/version_sbt.png)  
...
![SBT iniciar](../images/parte1/creacion_sbt.png)  

   Aqui mostramos la configuracion del archivo `build.sbt`

![configuracion](../images/parte1/sbt_configuracion.png)    

7. **Compilar y ejecutar el programa**
   Para ejecutar el programa haremos un `sbt compile`

![SBT compile](../images/parte1/sbt_build.png)  

   Por último un `sbt run`.

![SBT run](../images/parte1/sbt_run.png)  
...
![web intelliJ](../images/parte1/instalacion_intelliJ.png)  
...
![plugin intelliJ](../images/parte1/pling_Scala.png) 
...
![build.sbt](../images/parte1/Proyecto_Scala_jkd17.png) 
...
![build intelliJ](../images/parte1/intelli_compile.png) 
...
![run intelliJ](../images/parte1/intelli_run.png) 

## 4. Estructura del Proyecto
A continuación se muestra la estructura típica de directorios y archivos para un proyecto de Scala con SBT:

![estructura intelliJ](../images/parte1/estructura_intelli.png) ![build intelliJ](../images/parte1/intelli_build.png)
